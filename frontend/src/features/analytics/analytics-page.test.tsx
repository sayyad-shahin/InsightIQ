...
const ANALYTICS: DatasetAnalytics = {
  ...
  kpis: {
    ...
    completeness: 98.5,
    numeric_count: 2,
    measures: [{ name: "revenue", total: 3520, mean: 293, min: 100, max: 900, is_primary: true }],
  },
  trend: {
    change_pct: 12.5,
    direction: "up",
    peak: { date: "2024-07-31", value: 900 },
    chart: chart("area") as never,
  },
  category_breakdown: {
    dimension: "region",
    measure: "revenue",
    rows: [{ name: "North", value: 1000, pct: 28 }],
    bar: chart("bar") as never,
    pie: chart("pie") as never,
  },
  ...
  correlation: {
    ...
    top_pairs: [{ a: "revenue", b: "orders", value: 0.98 }],
  },
  distributions: {},
    ...
    items: [
      {
        ...
        upper_bound: 500,
        extremes: [900],
        root_cause: "1 value outside range",
      },
    ],
    chart: null,
    recommendations: ["Review revenue outliers"],
  },
  insights: {
    key_insights: ["12 records across 5 columns."],
    opportunities: ["Grow South"],
    risks: ["Concentration risk"],
    revenue_drivers: ["orders drives revenue"],
    growth_trends: ["revenue grew 12%"],
    recommendations: ["Proceed to forecasting"],
  },
};
