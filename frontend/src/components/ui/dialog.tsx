...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-muted-foreground opacity-70 transition hover:bg-accent hover:opacity-100 focus:outline-none">
          <X className="size-4" />
